...
const InventoryTable = ({
  ...
  return (
    <div className={`rounded-md shadow overflow-x-auto transition-colors duration-500 ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'}`}>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 border-b dark:border-gray-700 gap-4">
        <div>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-sm">
          <thead className="rounded-md bg-emerald-500 text-white">
            <tr>
              <th className="text-left px-4 py-2 whitespace-nowrap">Item Details</th>
              <th className="text-left px-4 py-2 whitespace-nowrap">Brand</th>
              <th className="text-left px-4 py-2 whitespace-nowrap">Size/Color</th>
              <th className="text-left px-4 py-2 whitespace-nowrap">Quantity</th>
              <th className="text-left px-4 py-2 whitespace-nowrap">Price</th>
              ...
              <tr key={index} className="border-t dark:border-gray-700">
                {editingItem === item.sku ? (
                  <>
                    ...
                    <td className="px-4 py-2 min-w-[130px]">
                      <select
                        ...
                        onChange={handleEditChange}
                        className={`w-full border px-3 py-2 rounded transition-colors duration-500 ${darkMode ? 'bg-gray-700 text-white border-gray-600' : 'bg-white text-gray-900 border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                      >
                    ...
                    <td className="px-4 py-2 space-x-1 whitespace-nowrap min-w-[120px]">
                      <button
                  ...
                  <>
                    ...
                    <td className="px-4 py-2 min-w-[120px]">{item.brand}</td>
                    <td className="px-4 py-2 min-w-[130px]">Size: {item.size}<br />{item.color}</td>
                    <td className="px-4 py-2 min-w-[100px]">
                    ...
                    <td className="px-4 py-2 min-w-[100px]">₹{item.price.toFixed(2)}</td>
                    <td className="px-4 py-2 min-w-[100px]">{item.location}</td>
                    <td className="px-4 py-2 min-w-[130px]">
                    ...
                    <td className="px-4 py-2 space-x-3 text-lg min-w-[100px]">
